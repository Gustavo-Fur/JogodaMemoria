...
const IMAGES = [
    { key: 'AlienX1', src: 'img/AlienX1.webp', alt: 'AlienX'},
    { key: 'ameaca-aquatica', src: 'img/ameaca-aquatica.png', alt: 'Ameaça-Aquática'},
    { key: 'eco-eco', src: 'img/eco-eco.webp', alt: 'Eco Eco'},
    { key: 'Fantasmatico', src: 'img/Fantasmatico.webp', alt: 'Fantasmatico'},
    { key: 'four-arms', src: 'img/four-arms.png', alt: 'Quatro Braços'},
    { key: 'friagem', src: 'img/friagem.webp', alt: 'Friagem'},
    { key: 'XLR8', src: 'img/XLR8.webp', alt: 'XRl8'},
    { key: 'upgrade', src: 'img/upgrade.png', alt: 'UP'},
    { key: 'cromatico', src: 'img/cromatico.webp', alt: 'Cromatico'}
];
